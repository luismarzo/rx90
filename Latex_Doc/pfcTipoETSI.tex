...
\titulo{Multiple purpose simulation environment for robotics applications} %\mbox evita que se divida una palabra al cambiar de línea
\author{Luis Marzo Román}
\director{Begoña C. Arrue Ullés}
